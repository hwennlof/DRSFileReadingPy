...
int main(int argc, const char * argv[])
{
   ...
   for (n=0 ; ; n++) {
      ...
      printf("Found event #%d %d %d\n", eh.event_serial_number, eh.millisecond, ch.cn[3]);
      
      
      //std::cout << "AH! Så nästa loop händer aldrig!" << std::endl;
      
      // loop over all boards in data file
      for (b=0 ; b<=n_boards ; b++) {
		  std::cout << "b is " << b << std::endl;
		  
		  //Flera boards under ett event! (eventuellt.Inte för mig, men eventuellt)
         ...
         for (chn=0 ; chn<4 ; chn++) {
            ...
            //Varje board har 4 channels
            //Channel ger volt! Så från det här kan vi få kurvan.
            ...
            for (i=0 ; i<1024 ; i++) {
               ...
               //Waveform en 3D-array av doubles.
               //b är board number
               //i är bin number (?)
         ...
         //We want:
         //time on x-axis, and waveform on y-axis.
         //want time-waveform-duplets
